note
	...
	description: "[
				 Object representation of a path in an object graph ('OG'). This abstraction supports a path  concept similar to, and
				 convertible to Xpath paths. An OG path is a simplified form of an Xpath, and contains 'predicate' sections, e.g. 
				 /items[en] which in pure Xpath  would be /items[@node_id = 'en']. 
