...
feature -- Token codes
	...
	V_TERMINOLOGY_ID: INTEGER = 272
	V_URI: INTEGER = 273
	V_CHARACTER: INTEGER = 274
	SYM_START_DBLOCK: INTEGER = 275
	SYM_END_DBLOCK: INTEGER = 276
	SYM_EQ: INTEGER = 277
	SYM_ELLIPSIS: INTEGER = 278
	SYM_LIST_CONTINUE: INTEGER = 279
	SYM_INFINITY: INTEGER = 280
	SYM_INTERVAL_DELIM: INTEGER = 281
	SYM_DT_UNKNOWN: INTEGER = 282
